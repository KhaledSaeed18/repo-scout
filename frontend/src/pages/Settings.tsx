    ...
    <div className="flex flex-col gap-4">
      ...
      <Card className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
          <label className="text-sm text-slate-300">Ignored folders (comma separated)</label>
          <Input
        ...
        <div className="flex flex-col gap-1">
          <label className="text-sm text-slate-300">Ignored extensions</label>
          <Input
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="text-sm text-slate-300">Max file size (bytes)</label>
            <Input
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm text-slate-300">Max folder depth (0 = unlimited)</label>
            <Input
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm text-slate-300">Worker count</label>
            <Input
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm text-slate-300">Max search files</label>
            <Input
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm text-slate-300">Duplicate min lines</label>
            <Input
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm text-slate-300">Duplicate min similarity</label>
            <Input
              type="number"
              step="0.05"
        ...
        <div className="flex items-center gap-2">
          ...
          {save.isError && <span className="text-sm text-rose-400">{save.error.message}</span>}
        </div>
      </Card>
    </div>
  )
